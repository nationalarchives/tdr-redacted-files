...
class RedactedFileMatcherTest extends AnyFlatSpec with TableDrivenPropertyChecks {
  ...
  val redactionErrors: TableFor2[List[String], List[String]] = Table(
    ...
    (List("DTP_Redacted.docx"), List(noOriginalFileError)),
    (List("DTP_redacted1.docx"), List(noOriginalFileError)),
    (List("Anothe_Redacted_R.docx", "Anothe_Redacted.docx"), List(noOriginalFileError)),
