...
class RedactedFileMatcherTest extends AnyFlatSpec with TableDrivenPropertyChecks {
  ...
  private def toFile(fileName: String): File =
    File(UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID(), "standard", "1", "checksum", fileName, None, None, None, None, None, None, FileCheckResults(Nil, Nil, Nil))
  ...
  val validTestData: TableFor2[List[String], Map[String, String]] = Table(
    ...
    (List("DTP_Redacted.docx", "DTP.docx"), Map("DTP_Redacted.docx" -> "DTP.docx")),
    (List("DTP_Redacted1.pdf", "DTP.docx"), Map("DTP_Redacted1.pdf" -> "DTP.docx")),
    (List("DTP_redacted.docx", "DTP.docx"), Map("DTP_redacted.docx" -> "DTP.docx")),
    (List("DTP_redacted2.pdf", "DTP.docx"), Map("DTP_redacted2.pdf" -> "DTP.docx")),
    (List("DTP.docx", "DTP_R.docx", "DTP_Redacted1.pdf", "DTP_redacted2"), Map("DTP_R.docx" -> "DTP.docx", "DTP_Redacted1.pdf" -> "DTP.docx", "DTP_redacted2" -> "DTP.docx")),
    ...
    (List("DTP_R1.docx"), Map("DTP_R1.docx" -> noOriginalFileErrorMessage)),
    (List("DTP_R.docx"), Map("DTP_R.docx" -> noOriginalFileErrorMessage)),
    (List("DTP_Redacted.docx"), Map("DTP_Redacted.docx" -> noOriginalFileErrorMessage)),
    (List("DTP_redacted1.docx"), Map("DTP_redacted1.docx" -> noOriginalFileErrorMessage)),
    (List("Anothe_Redacted_R.docx", "Anothe_Redacted.docx"), Map("Anothe_Redacted_R.docx" -> "Anothe_Redacted.docx", "Anothe_Redacted.docx" -> noOriginalFileErrorMessage)),
    (List("/dir1/DTP_R.docx", "/dir1/dir2/DTP.docx"), Map("/dir1/DTP_R.docx" -> noOriginalFileErrorMessage)),
    (List("/dir1/dir2/DTP_R.docx", "/dir1/DTP.docx"), Map("/dir1/dir2/DTP_R.docx" -> noOriginalFileErrorMessage)),
    (List("/dir1/dir2/DTP_R.docx", "/dir1/dir3/DTP.docx"), Map("/dir1/dir2/DTP_R.docx" -> noOriginalFileErrorMessage)),
    (List("DTP__R.docx", "DTP.docx"), Map("DTP__R.docx" -> noOriginalFileErrorMessage)),
    (List("DTP_R"), Map("DTP_R" -> noOriginalFileErrorMessage)),
  )
  ...
  val redactionErrors: TableFor2[List[String], List[String]] = Table(
    ...
    (List("DTP.docx", "DTP_Redacted.docx", "DTP_Redacted.pdf"), List(duplicateFileNameError, duplicateFileNameError)),
    (List("DTP.docx", "DTP_redacted", "DTP_redacted.pdf"), List(duplicateFileNameError, duplicateFileNameError)),
    (List("DTP.docx", "DTP.pdf", "DTP_R1.docx"), List(ambiguousOriginalFileError)),
    (List("DTP.docx", "DTP.pdf", "DTP_Redacted1.docx"), List(ambiguousOriginalFileError)),
    (List("DTP.docx", "DTP.pdf", "DTP_redacted.docx"), List(ambiguousOriginalFileError)),
