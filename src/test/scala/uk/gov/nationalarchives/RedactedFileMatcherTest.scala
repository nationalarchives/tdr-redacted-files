...
class RedactedFileMatcherTest extends AnyFlatSpec with TableDrivenPropertyChecks {
  ...
  val validTestData: TableFor2[List[String], Map[String, String]] = Table(
    ...
    (List("DTP_R.docx"), Map("DTP_R.docx" -> noOriginalFileError)),
    (List("DTP_R1.docx"), Map("DTP_R1.docx" -> noOriginalFileError)),
    (List("DTP_Redacted.docx"), Map("DTP_Redacted.docx" -> noOriginalFileError)),
    (List("DTP_redacted1.docx"), Map("DTP_redacted1.docx" -> noOriginalFileError)),
    (List("DTP_R"), Map("DTP_R" -> noOriginalFileError)),
    (List("DTP__R.docx", "DTP.docx"), Map("DTP__R.docx" -> noOriginalFileError)),
    (List("/dir1/DTP_R.docx", "/dir1/dir2/DTP.docx"), Map("/dir1/DTP_R.docx" -> noOriginalFileError)),
    (List("/dir1/dir2/DTP_R.docx", "/dir1/DTP.docx"), Map("/dir1/dir2/DTP_R.docx" -> noOriginalFileError)),
    (List("/dir1/dir2/DTP_R.docx", "/dir1/dir3/DTP.docx"), Map("/dir1/dir2/DTP_R.docx" -> noOriginalFileError)),
    (List("Anothe_Redacted_R.docx", "Anothe_Redacted.docx"), Map("Anothe_Redacted_R.docx" -> "Anothe_Redacted.docx", "Anothe_Redacted.docx" -> noOriginalFileError)),
